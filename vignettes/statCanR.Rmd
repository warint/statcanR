...
In details, the _sqs_statcan_data_ function has 2 arguments to fulfill to get data:   
...
The global process of the _sqs_statcan_data_ function:
...
To go deeper in the _sqs_statcan_data_ function treatment, here is below a line-by-line of code description:   
  ...
  The seventh applying of the _sqs_statcan_data_ function consist to add the name of the table extract from the meta data table. 
  ...
  - `return(data)`:
  Finally, the last line of the _sqs_statcan_data_ function allows to return the value of the function treatment into the IDE.



# Practical usage

This section present an example of how to use the _statcanR_ R package and its function _sqs_statcan_data_.    
...
Once the correct table number of the statistics you are looking for is found out, you can easily used the _sqs_statcan_data_ to collect the data, as following:  
