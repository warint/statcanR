...
In details, the _getCansimTbl_ function has 2 arguments to fulfill to get data:   
...
The global process of the _getCansimTbl_ function:
...
To go deeper in the _getCansimTbl_ function treatment, here is below a line-by-line of code description:   
  ...
  The seventh applying of the _getCansimTbl_ function consist to add the name of the table extract from the meta data table. 
  ...
  - `return(data)`:
  Finally, the last line of the _getCansimTbl_ function allows to return the value of the function treatment into the IDE.



# Practical usage

This section present an example of how to use the _statcanR_ R package and its function _getCansimTbl_.    
  

The example is provided to illustrate how to practical use the function as well as understand and know more about the Canadian labour force wages in terms of competitiveness and attractiveness thematic. Therefore, it consists to collect and present descriptive statistics of Canadian Labour Force Characteristics at a country and province geographical levels as well as based on a monthly frequency.  

With a simple web search '_statistics canada wages by industry metropolitan area monthly_', you can easily find the table number of the satistic you are looking for on the Statisitcs Canada data web page. Here is below a figure which illustrates this case for our example, such as '_14-10-0063-01_' for the _Employee wages by industry, monthly, unadjusted for seasonality at a country and provinces level_.

Once the correct table number of the statistics you are looking for is found out, you can easily used the _getCansimTbl_ to collect the data, as following:  
  
```{r, eval=FALSE}
# Get data with getCansimTbl function
dt <- getCansimTbl("14-10-0063-01", "eng")
```
