...
This is entirely optional: it adds no new package dependencies, and it makes no network request unless you call `statcan_chat()` yourself. It works with any OpenAI-compatible chat-completions endpoint. Configure it once per session:
