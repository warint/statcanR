...
[![Travis build status](https://travis-ci.com/warint/statcanR.svg?branch=master)](https://app.travis-ci.com/github/warint/statcanR)
...
This section presents an example of how to use the `statcanR` R package and its function `statcan_data()` and `statcan_download_data()`.    
...
Economics Program at Western University [biography](https://economics.uwo.ca/people/faculty/saunders.html)
